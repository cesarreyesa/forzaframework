 ...
 * org.springframework.web.bind.annotation.support.HandlerMethodResolver} for a specific handler type.
 *
...
public class HandlerMethodInvoker {
	...
	private WebDataBinder resolveModelAttribute(String attrName, MethodParameter methodParam,
		...
		if (implicitModel.containsKey(name)) {
            ...
            Class commandType;
            if(webRequest.getParameter("e") != null && paramType.equals(BaseEntity.class) && systemConfiguration != null){
                SystemEntity entity = systemConfiguration.getSystemEntity(webRequest.getParameter("e"));
                commandType = entity.getType();
            }else{
                commandType = paramType;
            }
            if(org.apache.commons.lang.StringUtils.isNotBlank(webRequest.getParameter("id")) && entityManager != null){
                bindObject = entityManager.get(commandType, Long.valueOf(webRequest.getParameter("id")));
            }else{
